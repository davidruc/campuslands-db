...
class design_area extends connect{
    ...
    private $queryUpdate = 'UPDATE design_area SET id_area = :fk_area, id_staff = :fk_staff, id_position = :fk_posicion, id_journeys = :fk_journeys WHERE id = :identificador';
    ...
    public function getAllDesingArea(){
        try{
