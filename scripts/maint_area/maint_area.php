...
class maint_area extends connect{
    private $queryPost = 'INSERT INTO maint_area(id, id_area, id_staff, id_position, id_journeys) VALUES (:identificador, :fk_area, :fk_staff, :fk_posicion, :fk_journeys)';
    private $queryGetAll = 'SELECT id AS "identificador", id_area AS "fk_area", id_staff AS "fk_staff", id_position AS "fk_posicion", id_journeys AS "fk_journeys" FROM maint_area';
    private $queryUpdate = 'UPDATE maint_area SET id_area = :fk_area, id_staff = :fk_staff, id_position = :fk_posicion, id_journeys = :fk_journeys WHERE id = :identificador';
    ...
    public function getAllMaintAreax(){
        try{
